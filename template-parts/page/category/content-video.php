<?php
/**
 * Template part for displaying page content in video.php
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-content">
		<div class="grid">
			...
			<?php $query = new WP_Query( array( 'post_type' => 'proyects','category_name' => 'video-y-fotografia','posts_per_page' =>-1, ));
			if ( $query->have_posts() ) : 
