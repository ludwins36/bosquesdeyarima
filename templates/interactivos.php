<?php
/**
 * Template Name: Interactivos
 * The template for displaying the Video and Fotografia page
 *
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				get_template_part( 'template-parts/page/category/content', 'interactivos' );
